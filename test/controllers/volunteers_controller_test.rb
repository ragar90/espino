...
class VolunteersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create volunteer" do
    assert_difference('Volunteer.count') do
      post volunteers_url, params: { volunteer: { email: @volunteer.email, host_capacity: @volunteer.host_capacity, lastname: @volunteer.lastname, name: @volunteer.name, type: @volunteer.type } }
    end
  ...
  test "should update volunteer" do
    patch volunteer_url(@volunteer), params: { volunteer: { email: @volunteer.email, host_capacity: @volunteer.host_capacity, lastname: @volunteer.lastname, name: @volunteer.name, type: @volunteer.type } }
